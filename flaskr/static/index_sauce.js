...
const big_screen = window.matchMedia("(min-width:1024px)")
const small_screen_min_width = window.matchMedia("(min-width:300px)")
const small_screen_max_width = window.matchMedia("(max-width:600px)")
...
document.body.onload = () =>{
    ...
    else if (small_screen_min_width.matches && small_screen_max_width.matches){
        projects.addEventListener("click", (e) => {
            e.preventDefault()
            services.style.flexGrow = 0.01;
